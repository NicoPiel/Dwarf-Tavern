...
public class ItemBeerHolder : MonoBehaviour
{
    ...
    public bool Set(ItemBeer itemBeer, int slot)
    {
        switch (slot)
        {
            case 1:
    ...
    public bool IsFull()
    {
        return _itemBeer1 != null && _itemBeer2 != null && _itemBeer3 != null && _itemBeer4 != null && _itemBeer5 != null;
    }
